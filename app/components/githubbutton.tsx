  ...
  return (
    <div className="flex justify-center">
      ...
      >
        ...
        >
          <span className="flex items-center justify-center gap-2 rounded-lg px-2 text-xl font-semibold tracking-wide whitespace-nowrap text-white group-hover:text-yellow-400 xl:justify-between xl:px-4">
            <Star className="hidden h-6 w-6 flex-shrink-0 fill-white group-hover:fill-yellow-400 xl:inline-block" />
            <Github className="inline-block h-6 w-6 flex-shrink-0 fill-white group-hover:fill-yellow-400 xl:hidden" />
            <span className="hidden xl:inline-block">Github</span>
          </span>
        </button>
      </a>
    </div>
